	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/role/queryRoleList.action">角色管理</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/role/toRoleAdd.action'">
									...
									<c:forEach items="${pageInfo.list}" var="role" varStatus="status">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/toRolePermissionAdd.action?id=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
		...
		<script>
                    ...
                    function  gotoPage(pageNum) {
                        ...
                        if(pageNum >=1 && pageNum <=${pageInfo.pages}) {
                            ...
                            location.href = "${pageContext.request.contextPath}/role/queryRoleList.action?pageNum="+pageNum+"&pageSize="+pageSize;
                        }else{
                            //页码不合法，默认跳转第一页
                            gotoPage("1");
                        }
