	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/permission/queryPermissionList.action">权限管理</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick='location.href="${pageContext.request.contextPath}/permission/toPermissionAdd.action"'>
		...
		<script>
                    ...
                    function  gotoPage(pageNum) {
                        ...
                        if(pageNum >=1 && pageNum <=${pageInfo.pages}) {
                            ...
                            location.href = "${pageContext.request.contextPath}/permission/queryPermissionList.action?pageNum="+pageNum+"&pageSize="+pageSize;
                        }else{
                            //页码不合法，默认跳转第一页
                            gotoPage("1");
                        }
