	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a href="${pageContext.request.contextPath}/permission/queryPermissionList.action">权限资源管理</a></li>
				<li class="active">权限资源表单</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="${pageContext.request.contextPath}/permission/savePermission.action"
				method="post">
				<!-- 正文区域 -->
				<section class="content">
					...
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-2 title">父菜单</div>
							<div class="col-md-4 data">
								<select  class="form-control select2" style="width: 100%"
									 name="pid">
									<c:forEach items="${parentList}" var="permission" varStatus="status">
