...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/orders/updateOrders.action"
				method="post">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<%--<input type="text" class="form-control" placeholder="路线名称"
								...
								<select id="productName" class="form-control select2" style="width: 100%"
									name="product.id">
									<%--查询出全部的产品数据productList，循环打印输出option--%>
								...
								<%--
                                                                        可以使用jquery
                                                                        找到option元素（option的value值等于后台传递过来的productStatus）
                                                                --%>
						</div>
						...
						<div class="col-md-4 data">
							<%--<input type="text" class="form-control" placeholder="支付方式"
								value="${order.payType==0?'支付宝':order.payType==1?'微信':'其他'}" name="order.payType">--%>
							<select id="payType" class="form-control select2" style="width: 100%"
								name="payType">
						...
						<div class="col-md-4 data">
							<%--<input type="text" class="form-control" placeholder="订单状态"
							       value="${order.orderStatus==0?'未支付':'已支付'}" name="order.orderStatus">--%>
							<select id="orderStatus" class="form-control select2" style="width: 100%"
								name="orderStatus">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="出发城市"
							       value="${order.product.cityName}" name="order.product.cityName">
						</div>
						...
						<div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="其他信息"
								  name="orderDesc">${order.orderDesc }</textarea>
						</div>
					</div>
				</div>
				<!--订单信息/-->
	...
	<script>
		...
		<%--确定下拉框默认选中的值为订单中的数据--%>
		$("#productName option[value='${order.product.id}']").prop("selected",true);
		$("#payType option[value='${order.payType}']").prop("selected",true);
		$("#orderStatus option[value='${order.orderStatus}']").prop("selected",true);
